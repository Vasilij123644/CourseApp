...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseList.add(new Course(3, "unity", "Профессия Unity\nразработчик", "13 декабря", "Начальный", "#65173D", "Cпециалист, который создает игры на движке Unity. Профессия интересная, востребованная и главное, хорошо оплачиваемая. Если вы решили погрузиться в мир геймдева, но не знаете, с чего начать, наш курс «Как стать Unity-разработчиком с нуля» точно будет вам полезен.", 1));
